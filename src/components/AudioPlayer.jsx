...
export default function AudioPlayer() {
  ...
  return (
    <div className="absolute top-4 right-4 z-[9999] pointer-events-auto">
      ...
      <button 
        onClick={togglePlay}
        className="rounded-full p-[6px] border border-[#ffd700] text-[#ffd700] bg-black/40 hover:scale-110 active:scale-95 transition-all flex items-center justify-center cursor-pointer"
